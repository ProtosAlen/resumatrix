...
import { RootState } from '@/store/store'; // Assuming resume data is stored in Redux store
...
export default async function generateResumePDF(resumeData: RootState['resumeData']): Promise<Uint8Array> {
  const doc = (
    <Document>
